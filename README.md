...
# analitical_med_modes_f.py -> First version with rotation (f!=0)
# analitical_med_modes_f_bdycond2.py -> Version with rotatio (f!=0) and the bdy conditions imposed as a filter on the modes
#
